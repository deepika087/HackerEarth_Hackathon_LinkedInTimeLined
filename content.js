	 ...
	 */
	 ...
	 console.log("================MAIN END=================");
	  ...
	  if (items.length > 0) {
	  	...
	  	console.log("Deepika" + range.start + " END: " + range.end);
	  	var percentage = -0.2;

	  	//Zoom the timeline
	  	
        var interval = range.end - range.start;
        console.log("Deepika Interval = " + interval);
        ...
        console.log("New Deepika Interval = " + timeline.getWindow().start + "NEW END: " + timeline.getWindow().end);
	  }
